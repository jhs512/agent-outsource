...
import { sleep } from '../skills/cli-worker-bridge/scripts/process.mjs';
...
const daemon = spawn(process.execPath, ['skills/cli-worker-bridge/scripts/bridge.mjs', 'serve', '--db', dbFile], { env, windowsHide: true, stdio: ['ignore', log, log] });
fs.closeSync(log);
const evidence = [];
